...
initial_capacity_battery=0; % KWh
minimum_capacity_battery=0; %KWh
maximum_capacity_battery=10; %KWh

max_batt_discharge=5;%KW
max_batt_charge=1; %KW %5KW
...
a=importdata('micro_grid_dataIC.csv');
...
Load=a.data(1:192,2);%Pload (KW) per each quarter hour
Load=Load';
...
figure(1);
subplot(2,2,1)
stem(Pbuy_interval,'BaseValue',0)
